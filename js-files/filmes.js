...
for (let index in obj) {
    let moviesObjects = obj[index]

    let justTitle = moviesObjects.Title
    let justPlot = moviesObjects.Plot
    let justGenre = new Array (moviesObjects.Genre)
    let justLanguage = new Array (moviesObjects.Language)

    console.log(' ')
    console.log(' ')
    console.log(justTitle)
    console.log('---------------------------------------------------------')
    console.log('Genre:')
    console.log(justGenre)
    console.log('Language:')
    console.log(justLanguage)
    console.log('Plot:')
    console.log(justPlot)
}
